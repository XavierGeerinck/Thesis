...
public class InfluxDBConnector extends RichSinkFunction<data.Measurement> {
    ...
    public InfluxDBConnector(String host, String username, String password, String databaseName){
        this.host = host;
